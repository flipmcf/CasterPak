...
gnome-terminal --window --title="Filesystem" --geometry=80x24+800+0 -- bash -c "$CMD_INPUT_FILES"
gnome-terminal --window --title="Filesystem" --geometry=80x24+800+0 -- bash -c "$CMD_SEGMENTS"
